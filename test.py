...
<div class="nav-items">
  <ul>
    ...
    <div id="db-usr-profile">
        <div class="pic">
            <a href="/people/anasshole/">
                <img height="48" width="48" alt="圣泉麦浪" src="https://img1.doubanio.com/icon/u68846018-18.jpg" />
            </a>
        </div>
        <div class="info">
            <h1>圣泉麦浪看过的电影(1397)</h1>
            <ul>
                    
        <li><a href="/people/anasshole/">电影主页</a></li>
    
                    
        <li><a href="/people/anasshole/reviews">影评</a></li>
    
                    
        <li><a href="/people/anasshole/question">问答</a></li>
    
                    
        <li><a href="/people/anasshole/do">在看</a></li>
    
                    
        <li><a href="/people/anasshole/wish">想看</a></li>
    
                    
        <li><a href="/people/anasshole/collect">看过</a></li>
    
                    
        <li><a href="https://www.douban.com/people/anasshole/doulists">豆列</a></li>
    
                    
        <li><a href="https://www.douban.com/people/anasshole/subject_doulists/movie">片单</a></li>
    
                    
        <li class="sep">|</li>
    
                    
        <li><a href="https://www.douban.com/people/anasshole/">豆瓣主页</a></li>
    ...
    <div class="opt-bar mb30 clearfix">
        <div class="sort">
                ...
                按时间排序<span class="gray-dot">·</span><a href="/people/anasshole/collect?sort=rating&amp;start=0&amp;mode=grid&amp;tags_sort=count" class="ck-option" target="_self">按评价排序</a><span class="gray-dot">·</span><a href="/people/anasshole/collect?sort=title&amp;start=0&amp;mode=grid&amp;tags_sort=count" class="ck-option" target="_self">按标题排序</a>
        </div>
        <style>
            .tabs-more {zoom:1; float:left; margin-left:38px; position: relative; top:3px}
            .tabs-more .gray {color:#999}
            .tabs-more .lnk-tab-more{padding-right:5px;background:#fff;}
            .tabs-more .lnk-tab-more:hover{background:#369;}
            .tabs-more .lnk-tab-more span{background: url("/pics/icon/tongcheng_tab_down.gif") no-repeat right 3px;padding-right:10px;display:inline-block}
            .tabs-more .lnk-tab-more span.up{background: url("/pics/icon/tongcheng_tab_up.gif") no-repeat right 3px;padding-right:10px;}
            .tabs-more .lnk-tab-more:hover span{color:#fff;background: url("/pics/icon/tongcheng_tab_down.gif") no-repeat right -8px;}
            .tabs-more .lnk-tab-more:hover span.up{background: url("/pics/icon/tongcheng_tab_up.gif") no-repeat right -8px;}
            .tabs-more ul {display:none;position:absolute; background:#fff; border:1px solid #aaa; padding:5px 0; left:55px;_left:53px;_top:19px; top:18px; width:70px}
            .tabs-more ul li a {display:block;text-align:center; padding:3px 5px;margin:0}
            .tabs-more ul li{margin:0; zoom:1}
            .tabs-more ul li a:hover {background:#369; color:#fff; }

            .item .info li {clear: both;}
            .item .info li.intro {
                overflow: hidden;
            ...
            .item .title .playable {font-size: 13px; padding-left: 3px; color: #00A65F;}

            .grid-view .item {overflow:auto; display:table; width: 100%; zoom:1}
            .grid-view .item > .pic, .grid-view .item > .info {display: table-cell;vertical-align: top;float:initial;}
            .grid-view .item .tabs-more {margin-left:0;}
            .grid-view .item .tabs-more span {color:#369;}
            .grid-view .item .lnk-tab-more:hover span {color:#fff;}
            .grid-view .item .clearDiv {clear:both}
            .grid-view .item .tabs-more ul{left:0;margin-left:0}
            .grid-view .item .comment {color:#000;}

            .list-view .item {overflow:auto;display:table;width:100%; zoom:1}
            .list-view .item .tabs-more{margin-left:0; margin-top:4px}
            .list-view .item .tags{display:block;clear:both}
            .list-view .item .tabs-more ul{left:0}
            .list-view .item-show{height:17px;overflow:hidden}
            .list-view .opt-ln {clear:both;margin-left:3px}
            .list-view .comment {clear:both;}
            .list-view .movieInfo {margin-top:4px;*margin-top:3px}

        </style>

        <div class="tabs-more">
            
            <span class="gray">筛选影片:</span>
            <a class="lnk-tab-more" href="#">
                <span>全部</span>
            </a>
            <ul class="tabs-more-list">
                <li><a href="/people/anasshole/collect?sort=time&amp;amp;start=0&amp;amp;filter=schedule&amp;amp;mode=grid&amp;amp;tags_sort=count">正在热映</a></li>
                <li><a href="/people/anasshole/collect?sort=time&amp;amp;start=0&amp;amp;filter=video&amp;amp;mode=grid&amp;amp;tags_sort=count">在线观看</a></li>
            </ul>
        </div>
        <div class="mode">
            ...
            <ul class="grid-list-bar">
                    ...
                    <li class="list">
                        <a href="/people/anasshole/collect?sort=time&amp;amp;start=0&amp;amp;filter=all&amp;amp;mode=list&amp;amp;tags_sort=count">list</a>
                    </li>
            </ul>
        </div>
    </div>
...
<div class="grid-view">
        ...
        <span class="prev">
            &lt;前页
                ...
                <span class="thispage" data-total-page="94">1</span>
                
            <a href="/people/anasshole/collect?start=15&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >2</a>
        
                
            <a href="/people/anasshole/collect?start=30&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >3</a>
        
                
            <a href="/people/anasshole/collect?start=45&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >4</a>
        
                
            <a href="/people/anasshole/collect?start=60&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >5</a>
        
                
            <a href="/people/anasshole/collect?start=75&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >6</a>
        
                
            <a href="/people/anasshole/collect?start=90&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >7</a>
        
                
            <a href="/people/anasshole/collect?start=105&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >8</a>
        
                
            <a href="/people/anasshole/collect?start=120&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >9</a>
        
            <span class="break">...</span>
                
            <a href="/people/anasshole/collect?start=1380&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >93</a>
        
            <a href="/people/anasshole/collect?start=1395&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >94</a>
        
        <span class="next">
            <link rel="next" href="/people/anasshole/collect?start=15&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid"/>
            <a href="/people/anasshole/collect?start=15&amp;sort=time&amp;rating=all&amp;filter=all&amp;mode=grid" >后页&gt;</a>
        </span>
...
<div class="side-info">
    <a href="https://www.douban.com/people/anasshole/" class="side-info-avatar"><img height="48" width="48" alt="圣泉麦浪" src="https://img1.doubanio.com/icon/u68846018-18.jpg" /></a>
    <div class="side-info-txt">
        <h3>圣泉麦浪</h3>
        &gt;&nbsp;<a href="https://www.douban.com/people/anasshole/">豆瓣主页</a>
    </div>
    ...
    <div class="mod">
        <p class="pl2 m0">
            &gt; <a href="/people/anasshole/">圣泉麦浪的电影主页</a>
        </p>
    </div>
