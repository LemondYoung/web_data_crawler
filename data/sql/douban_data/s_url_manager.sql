CREATE TABLE `s_url_manager` (
  ...
  `style_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '风格代码',
...
) ENGINE=InnoDB AUTO_INCREMENT=3036 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='url管理表'